...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.first_file_manager_button = customtkinter.CTkButton(self.tabview.tab('Менеджер файлов'),
                                                                 ...
                                                                 command=self.rename_file_by_folder_name_info)
        ...
        self.fourth_file_manager_button.grid(row=3, column=0, padx=20, pady=(10, 10))
        self.five_file_manager_button = customtkinter.CTkButton(self.tabview.tab('Менеджер файлов'),
                                                                text='Слияние файлов',
                                                                command=self.file_dir_merge_info)
        self.five_file_manager_button.grid(row=4, column=0, padx=20, pady=(10, 10))
    ...
    def rename_file_by_folder_name_info(self):
